...
st.set_page_config(page_title="Web Search Chat Assistant", page_icon="🤗")
...
st.header("Chat with web results :books:")
user_question = st.chat_input("Ask a question answered with web search result:")
if user_question:
